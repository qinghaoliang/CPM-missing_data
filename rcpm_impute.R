###########################################################################
# CPM impute data at phenotypes level, predict the phenotype
# Input:
...
# id: the id of phenotype to predict
...
rcpm_impute <- function(all_edges, all_behav,
                        method, id, threshold = 0.01, alpha = 0,
